...
const BenefDetails = ({ params }) => {
	...
	const beneficiaryBalance = useBeneficiaryCache(Service.getBeneficiaryBalance, 'balance', { id });
			...
			<Row>
				<Col md="7">
					<DetailsCard
						...
						total_value={beneficiaryTotalIssued.value}
					/>
				</Col>
				<Col md="5">
					<Balance
						...
						token_data={beneficiaryBalance.value}
